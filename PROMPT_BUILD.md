...
0c. For reference, the application source code is in `auction-service/src/*`.
...
99999999999999. If you find inconsistencies in the specs/* then use an Opus 4.5 subagent to update the specs.
